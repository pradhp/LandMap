...
final class VideoDisplayAdaptor extends ArrayAdapter {
    ...
    public VideoDisplayAdaptor(Context context, int layoutResourceId, List dataSet) {
        ...
        if (row == null) {
            ...
            row.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.setDataAndType(Uri.parse(media.getRfPath()), "video/mp4");
