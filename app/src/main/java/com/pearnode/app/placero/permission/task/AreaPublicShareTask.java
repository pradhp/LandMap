...
public class AreaPublicShareTask extends AsyncTask<Object, Void, String> {

    private Context context;
    private TaskFinishedListener finishedListener;

    public AreaPublicShareTask(Context context, TaskFinishedListener listener) {
    ...
    protected String doInBackground(Object... params) {
        try {
            ...
            URL url = new URL(APIRegistry.AREA_MAKE_PUBLIC);
